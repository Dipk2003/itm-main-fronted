...
const AddProductForm: React.FC<AddProductFormProps> = ({ onSuccess, onCancel }) => {
  ...
  const loadCategories = async () => {
    try {
      ...
      if (Array.isArray(categoriesData)) {
        ...
        console.warn('⚠️ Categories API returned non-array data:', categoriesData);
        setCategories([]);
      }
    } catch (error: any) {
  ...
  // Debug logging
  console.log('🎯 AddProductForm render - Categories:', categories);
  console.log('🎯 AddProductForm render - CategoryOptions:', categoryOptions);

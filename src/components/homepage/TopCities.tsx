...
const cities: City[] = [
  { id: 'chennai', name: 'Chennai', image: city3, supplierCount: 9680, href: '/city/chennai' },
  { id: 'mumbai', name: 'Mumbai', image: city4, supplierCount: 18750, href: '/city/mumbai' },
  { id: 'jaipur', name: 'Jaipur', image: city9, supplierCount: 5670, href: '/city/jaipur' },
  { id: 'hyderabad', name: 'Hyderabad', image: city10, supplierCount: 10300, href: '/city/hyderabad' },
  { id: 'delhi', name: 'Delhi', image: city1, supplierCount: 15420, href: '/city/delhi' },
  { id: 'bengaluru', name: 'Bengaluru', image: city2, supplierCount: 12850, href: '/city/bengaluru' },
  { id: 'pune', name: 'Pune', image: city7, supplierCount: 11200, href: '/city/pune' },
  { id: 'kolkata', name: 'Kolkata', image: city6, supplierCount: 7340, href: '/city/kolkata' },

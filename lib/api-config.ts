...
const API_CONFIG = {
  ...
  API_BASE_URL: process.env.NEXT_PUBLIC_API_BASE_URL || 'https://indiantradebackend.onrender.com/api/v1',
  WS_URL: process.env.NEXT_PUBLIC_WEBSOCKET_URL || 'wss://indiantradebackend.onrender.com/ws',
